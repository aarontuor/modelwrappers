...
def return_parser():
    ...
    parser.add_argument("-threshold", metavar="THRESHOLD", type=float, default=0.3,
    ...
    parser.add_argument("-initrange", metavar="INIT_RANGE", type=float, default=1,
                        help="Weight on range for random initialization.")
    return parser
...
y = node_ops.dnn(x, [19], initrange=args.initrange,
                      activation='sigmoid')
...
model = generic_model.Model(objective, placeholderdict,
                                ...
                                save_tensors={'precision': precision, 'recall': recall, 'fscore': fscore},
